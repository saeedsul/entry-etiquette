...
import { ArrowLeft, Download, Printer, QrCode, Clock, Building, User, Phone, Mail } from "lucide-react";
...
const VisitorCard = () => {
  ...
  const [visitorId] = useState(() => Math.random().toString(36).substr(2, 8).toUpperCase());
  ...
  const handleDownload = () => {
    // Create a downloadable image of the visitor card
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <Card className="p-8 text-center">
          ...
          <Button onClick={() => navigate("/")} variant="kiosk">
            Start Over
          </Button>
        </Card>
      </div>
    ...
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-4xl mx-auto">
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="font-semibold text-slate-800">{visitorData.name}</p>
                    </div>
                  </div>
        ...
        <div className="mt-8 flex justify-between">
          <Button 
            variant="outline" 
            onClick={() => navigate("/visitor/photo")}
            className="h-12 px-8"
          >
